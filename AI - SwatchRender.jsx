// :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//
//       filename: AI - SwatchRender.jsx
//          coder: AdamRyan
//        program: Adobe Illustrator
//    description: This Script renders out all the swatches within the swatch pallet
//      extention: JSX
//       licensce: OpenSource
...
function is_dark(color){
    ...
    {  
        ...
        newGroup.position = [artboard.artboardRect[0]+50, artboard.artboardRect[1]-450];
        
        }

    var scaleX = 25.0;
    var scaleY = 25.0;
    app.activeDocument.groupItems.getByName("Swatches").resize(scaleX,scaleY);
